...
class MyApp(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Planet2.setPos(1125, 4300, 27)
        ...
        self.Planet3.setPos(215, 4300, 397)
        ...
        self.Planet4.setPos(13, 4300, 180)
        ...
        self.Planet5.setPos(222, 4300, 90)
        self.Planet5.setScale(47)
        ...
        self.Planet6.setPos(116, 4300, 293)
